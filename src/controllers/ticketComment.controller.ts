...
import TicketCommentService from "../services/ticketComment.service";
const service: TicketCommentService = new TicketCommentService();

export default class TicketCommentController extends Controller {
  constructor() {
    super();
  }
